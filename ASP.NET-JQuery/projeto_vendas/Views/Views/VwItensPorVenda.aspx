...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="container">
        <br /><center><h3>Carrinho de Compra</h3></center><br /><br />

        <asp:GridView ID="gdvProdutos" runat="server" AutoGenerateColumns="False" CssClass="table table-hover"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Valor">
                    <ItemTemplate>
                        <asp:Label ID="lblValorProduto" runat="server" Text='<%# Bind("valor") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <!--
    <br /><br /><center><h3>Itens já adicionados:</h3></center><br />
    <asp:GridView ID="gdvItensVenda" runat="server" AutoGenerateColumns="False" CssClass="table table-hover"
